...
<!--                   <a @click="changeToMyTeam(record)">团队</a>-->
                          <router-link
                            :to=" '/shoesClean/ShoeInvestors/ShoeInvestorsInfoList/'+record.investorsId">收益</router-link>

               </a-menu-item>
               <a-menu-item v-if="record.levelText==='代理'">

<!--                   <a @click="changeToMyTeam(record)">团队</a>-->
                <router-link
                  :to=" '/shoesClean/ShoeInvestors/ShoeInvestorsTeamInfoList/'+record.investorsId">团队</router-link>
               </a-menu-item>
              <a-menu-item>
