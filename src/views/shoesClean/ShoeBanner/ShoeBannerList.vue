...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('shoe_banner')">导出</a-button>-->
...
<!--      <j-super-query :fieldList="superFieldList" ref="superQueryModal" @handleSuperQuery="handleSuperQuery"></j-super-query>-->
    ...
    <shoe-banner-modal ref="modalForm" @ok="modalFormOk"></shoe-banner-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/shoes/shoeBanner/delete",
          deleteBatch: "/shoes/shoeBanner/deleteBatch",
          exportXlsUrl: "/shoes/shoeBanner/exportXls",
          importExcelUrl: "shoes/shoeBanner/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'image',text:'轮播图',dictCode:''})
