<template>
  <a-card :bordered="false">
    ...
    <shoe-xm-activity-modal ref="modalForm" @ok="modalFormOk"></shoe-xm-activity-modal>
  </a-card>
</template>
...
<script>
  ...
  import ShoeXmActivityModal from './modules/ShoeXmActivityModal'

  export default {
    name: 'ShoeXmActivityList',
    ...
    data () {
      return {
        description: 'shoe_xm_activity管理页面',
        // 表头
        columns: [
          {
            title:'昵称',
        ...
        url: {
          list: "/shoeXmActivity/shoeXmActivity/list",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'int',value:'xmActivityId',text:'id',dictCode:''})
