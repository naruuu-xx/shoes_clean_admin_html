  ...
  export default {
    ...
    data () {
      return {
        ...
        superFieldList:[],
        statusOptionList: [
          {"value":"", "name":"全部"},{"value":"0", "name":"待付款"}, {"value":"1", "name":"洗护中"},
          {"value":"2", "name":"待取件"}, {"value":"3", "name":"已完成"}, {"value":"4", "name":"已取消"},
          {"value":"5", "name":"退款中"}, {"value":"6", "name":"已退款"}, {"value":"7", "name":"异常"},
          {"value":"8", "name":"退回中"}],
      }
    },
    created() {
    ...
    methods: {
      ...
      handleOrderDetail(record){
        this.$refs.shoeOrderDetail.show(record);
      }
    }
  }
</script>
