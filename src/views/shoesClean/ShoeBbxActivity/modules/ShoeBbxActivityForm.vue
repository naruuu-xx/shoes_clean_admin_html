  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="id" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="bbxActivityId">
              <a-input-number v-model="model.bbxActivityId" placeholder="请输入id" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/shoeBbxActivity/shoeBbxActivity/add",
          edit: "/shoeBbxActivity/shoeBbxActivity/edit",
          queryById: "/shoeBbxActivity/shoeBbxActivity/queryById"
        }
      }
    },
    computed: {
